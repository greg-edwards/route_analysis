...
route_c = gpd.read_file(r"data\route_c.geojson")
route_ca = gpd.read_file(r"data\route_ca.geojson")
route_cb = gpd.read_file(r"data\route_cb.geojson")

#import stop geometry
route_stops = gpd.read_file(r'data\stops_routes.geojson')

#import route data
route_data = pd.read_excel(r'data\route_C_options.xlsx')
